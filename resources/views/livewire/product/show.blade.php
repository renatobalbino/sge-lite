<x-ui.page>
    <x-slot:header>
        ...
        >
            <x-slot:actions>
                <x-ui.button variant="primary" icon="edit" href="{{ route('admin.products.create', $product) }}">Editar Produto</x-ui.button>
            ...
            <div class="col-span-1 lg:col-span-2 space-y-4">
                <div class="flex items-center justify-between">
                    <div class="flex flex-col">
                        ...
                        <p class="text-xl font-semibold text-indigo-600">{{ $product->formatted_price }}</p>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="bg-white p-4 rounded-lg shadow border border-gray-200">
                        ...
                        <div class="text-xl font-bold text-gray-600 mt-1">R$ 1.250,00</div>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow border border-gray-200">
                        <div class="mb-2 text-gray-800 text-xs uppercase font-bold tracking-wider">Unidades Vendidas</div>
                        <div class="text-xl font-bold text-gray-600 mt-1">48</div>
                    </div>
    {{--                <div class="bg-white p-4 rounded-lg shadow border border-gray-200">--}}
    ...
    {{--                </div>--}}
                ...
                <div class="bg-white rounded-lg shadow border border-gray-200">
                    <div class="p-4 border-b border-gray-200">
                        <h3 class="text-sm font-bold text-gray-800 uppercase">Performance de Vendas (Últimos 30 dias)</h3>
                    </div>
                    ...
                    >
                        <div x-ref="chart" class="w-full h-full p-4"></div>
                    </div>
                </div>
            ...
            <div class="col-span-1 space-y-4">
                <h3 class="text-xl font-bold text-gray-900">Imagens</h3>
                <div
                    x-data="{
                ...
                >
                    <div class="h-80 w-full border-b border-gray-200 relative group flex items-center justify-center overflow-hidden cursor-zoom-in"
                         @click="openModal()"
                    >
